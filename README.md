...
```html
<script src="https://cdn.jsdelivr.net/npm/site-forms-placeholders@1.2.2/dist/site-forms-placeholders.min.js"></script>
```

or

```html
<script src="https://unpkg.com/site-forms-placeholders@1.2.2/dist/site-forms-placeholders.min.js"></script>
```
